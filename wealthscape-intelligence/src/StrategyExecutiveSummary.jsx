...
const summaries = {
  maintenance: {
    ...
    findings: {
      ...
      4: ["Candidate outcomes concentrate opportunity around incomplete requests and exception recovery.", "The highest-value outcomes cluster around establishing scope, collecting requirements, resolving rejected work and proving completion. The strategy signal is consistent: reduce rework by making missing information, ownership and completion status visible earlier."],
