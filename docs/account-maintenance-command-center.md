...
ODI / Jobs-to-be-Done boundary: the current account-maintenance strategy uses ODI as a research frame, not as a completed statistical study. The job structure should stay stable over time, but the existing outcome scores are directional synthesis inputs from secondary research and executive-study artifacts. Do not present them as survey-validated ODI opportunity scores. A formal follow-up should translate the candidate outcomes into solution-neutral desired-outcome statements, survey importance and satisfaction, and use factor and cluster analysis to identify needs-based segments before treating the opportunity map as final prioritization evidence. Strategy interpretation should remain consistent with the quadrant logic: underserved outcomes are candidates for investment, table-stakes outcomes must be maintained, overserved outcomes may be simplified or deprioritized, and low-importance outcomes generally should not drive funding.
